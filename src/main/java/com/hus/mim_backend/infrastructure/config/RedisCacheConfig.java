...
public class RedisCacheConfig {
    ...
    public RedisCacheManager cacheManager(RedisConnectionFactory connectionFactory) {
        ...
        RedisCacheConfiguration defaultConfig = RedisCacheConfiguration.defaultCacheConfig()
                ...
                .computePrefixWith((cacheName) -> "mim:" + cacheName + ":");

        Map<String, RedisCacheConfiguration> cacheConfigurations = new HashMap<>();
        cacheConfigurations.put(CacheNames.PUBLIC_POSTS, defaultConfig.entryTtl(Duration.ofMinutes(2)));
        cacheConfigurations.put(CacheNames.PUBLIC_RESEARCH_PAPERS, defaultConfig.entryTtl(Duration.ofMinutes(2)));
        ...
        cacheConfigurations.put(CacheNames.PUBLIC_RESEARCH_PAPER_DETAILS, defaultConfig.entryTtl(Duration.ofMinutes(5)));
